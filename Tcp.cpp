...
***********************************************************************/
int Tcp::sendData(string data, int acceptDescriptor) {
	int data_len = data.length();
	const char * datas = data.c_str();
	int sent_bytes = send(this->isServer ? acceptDescriptor
...
***********************************************************************/
int Tcp::reciveData(char* buffer, int size,int acceptDescriptor) {
	int read_bytes = recv(this->isServer ? acceptDescriptor
...
int Socket::acceptDescriptorCommunicate() {
    //accept
    int acceptDescriptor;
    struct sockaddr_in client_sin;
    unsigned int addr_len = sizeof(client_sin);
    acceptDescriptor = accept(this->socketDescriptor,
