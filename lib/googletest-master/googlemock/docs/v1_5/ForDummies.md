...
using ::testing::_;
...
// Expects the turtle to moveOneStep forward.
...
Then, if you feel like increasing your mock quotient, you should moveOneStep on to the [CookBook](V1_5_CookBook.md). You can learn many advanced features of Google Mock there -- and advance your level of enjoyment and testing bliss.